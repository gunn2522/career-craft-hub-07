        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input placeholder="Contact Person Name" value={formData.contact_name} onChange={(e) => setFormData({ ...formData, contact_name: e.target.value })} required />
              <Input type="email" placeholder="Contact Email" value={formData.contact_email} onChange={(e) => setFormData({ ...formData, contact_email: e.target.value })} required />
              <Input placeholder="Contact Phone (optional)" value={formData.contact_phone} onChange={(e) => setFormData({ ...formData, contact_phone: e.target.value })} />
              <Textarea placeholder="Your message or inquiry details..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} rows={4} />
              ...
              <div className="space-y-4">
                {inquiries.map((inquiry) => (
                  <div key={inquiry.id} className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground line-clamp-2 mb-2">{inquiry.message || "No message"}</p>
